public class LeasingCost {
	...
	public static Vehicle createVehicle(String description){
        ...
        String substring = description.substring(description.indexOf("name"), description.lastIndexOf(";"));
        ...
        substring = description.substring(description.indexOf("mile/unit"), description.lastIndexOf(";"));
        if (substring.indexOf(";") == -1) {
            substring = substring.substring(substring.indexOf(":") + 1, substring.length());
            }
        else {
        ...
        double usage = Double.parseDouble(substring);
        Fuel fuel = new Fuel(usage);
        substring = description.substring(description.indexOf("type"), description.lastIndexOf(";"));
        if (substring.indexOf(";") == -1) {
            substring = substring.substring(substring.indexOf(":") + 1, substring.length());
            }
        else {
        ...
        if (type.equals("electric")) {
            substring = description.substring(description.indexOf("charger"), description.lastIndexOf(";"));
            if (substring.indexOf(";") == -1) {
                substring = substring.substring(substring.indexOf(":") + 1, substring.length());
                }
            else {
            ...
            double charger = Double.parseDouble(substring);
            fuel = new Fuel(usage, charger);
        }
        substring = description.substring(description.indexOf("due"), description.lastIndexOf(";"));
        if (substring.indexOf(";") == -1) {
            substring = substring.substring(substring.indexOf(":") + 1, substring.length());
            }
        else {
        ...
        double dueAtSigning = Double.parseDouble(substring);
        substring = description.substring(description.indexOf("length"), description.lastIndexOf(";"));
        if (substring.indexOf(";") == -1) {
            substring = substring.substring(substring.indexOf(":") + 1, substring.length());
            }
        else {
        ...
        int leaseLength = Integer.parseInt(substring);
        substring = description.substring(description.indexOf("monthly"), description.lastIndexOf(";"));
        if (substring.indexOf(";") == -1) {
            substring = substring.substring(substring.indexOf(":") + 1, substring.length());
            }
        else {
        ...
        double monthlyCost = Double.parseDouble(substring);
        substring = description.substring(description.indexOf("allowance"), description.lastIndexOf(";"));
        if (substring.indexOf(";") == -1) {
            substring = substring.substring(substring.indexOf(":") + 1, substring.length());
            }
        else {
        ...
        int mileageAllowance = Integer.parseInt(substring);
	...
	public static void computeCO2EmissionsAndCost( Vehicle[] vehicles, double gasPrice, double electricityPrice ){
        ...
        for (int i = 0; i < vehicles.length; i++) {
            int numberOfMonth = (vehicles[i].getLease()).getLeaseLength();
            ...
            double co2Emission = computeCO2(numberOfMonth, usage, mileageAllowance, co2PerUnit);
            double leaseCost = computeLeaseCost(dueAtSigning, numberOfMonth, monthlyCost);
            vehicles[i].setCO2Emission(co2Emission); 
            vehicles[i].setFuelCost(fuelCost);
            if ((vehicles[i].getFuel()).getType() == 2) {
                vehicles[i].setTotalCost(fuelCost + leaseCost + (vehicles[i].getFuel()).getCharger());
            }
            else {
